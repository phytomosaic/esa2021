...
scree <- scree_nms(D, k=5, trymax=10)  # 2 dimensions seems ok...
scree
```
...
We focus on a measure called Blomberg's _K_.  A value of _K_ > 1.0 indicates that traits of related species are more similar than expected from Brownian motion, and _K_ < 1.0 indicates traits of related species are more dissimilar than expected at random.
